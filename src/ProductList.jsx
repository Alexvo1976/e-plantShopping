...
function ProductList({ onHomeClick }) {
  ...
  const [showPlants, setShowPlants] = useState(false); // Controls visibility of the Plants page
  const [addedToCart, setAddedToCart] = useState({});

  // Redux hooks: dispatch actions and select cartItems from the store
  ...
  // Inline styles for the navbar and elements
  const styleObj = {
  ...
  // Event handlers for navigation and cart interactions
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    {/* Display additional plant details (e.g., description, cost) here if needed */}
                    <button
